...
namespace ATM
{
    class Program
    {
        static void Main(string[] args)
        {
            Customer[] customers = new Customer[3]
           {
            ...
            while (true)
            {
                ...
                if (op.ToUpper() == "L")
                {
                    long cardNumber = InputCardNumber(customers);
        ...
        static long InputCardNumber(Customer[] customers)
        {
            while (true)
            {
                ...
                long cardParse = ConvertNumber(cardNumber);
        ...
        public static long ConvertNumber(string cardNumber)
        {
            string numberString = "";
            ...
            long.TryParse(numberString, out long numberDouble);
            return numberDouble;
        }
        public static void Register(ref Customer[] customers)
        {
            ...
            long cardNumber = CheckCardNumber(customers);
        ...
        public static long CheckCardNumber(Customer[] customers)
        {
            while (true)
            {
                ...
                long cardNumber = ConvertNumber(numberString);
